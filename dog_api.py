...
def get_random_image(breed):
    ...
    try:
        ...
        if data["status"] == "success":
            ...
            return "Error: Could not fetch image for the given breed."
    except requests.exceptions.RequestException:
        return "Error: Could not fetch image from API."
...
def get_random_sub_breed_image(breed, sub_breed):
    ...
    try:
        ...
        if data["status"] == "success":
            ...
            return "Error: Could not fetch image for the given sub-breed."
    except requests.exceptions.RequestException:
        return "Error: Could not fetch image from API."
    ...
    while True:
        ...
        if choice == "1":
            ...
            if breed in breeds and breeds[breed]:
                ...
                print(f"The breed '{breed}' has no sub-breeds.")
            else:
                print("Invalid breed. Please try again.")
